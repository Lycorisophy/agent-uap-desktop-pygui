...
from uap.core.memory.vector.embeddings import (
    EmbeddingService,
    OllamaEmbeddings,
    OpenAIEmbeddings,
...
from uap.core.memory.vector.search_service import (
    RAGContext,
    SearchResult,
    VectorSearchService,
    create_search_service,
)
from uap.core.memory.vector.vector_store import VectorRecord, VectorStore
...
def create_search_service(
    ...
    **embedding_kwargs
    ...
    """
    from uap.core.memory.vector.search_service import create_search_service as _create
