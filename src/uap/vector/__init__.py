...
from uap.vector.embeddings import (
    EmbeddingService,
    OllamaEmbeddings,
    OpenAIEmbeddings,
...
from uap.vector.search_service import (
    VectorSearchService,
    SearchResult,
    RAGContext,
...
def create_embedding_service(
    ...
    **kwargs
    ...
    Returns:
        EmbeddingService 实例
    """
    from uap.vector.embeddings import create_embedding_service as _create
...
def create_search_service(
    ...
    **embedding_kwargs
    ...
    """
    from uap.vector.search_service import create_search_service as _create
